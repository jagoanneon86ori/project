...
BUFLEN = 4096 * 4
TIMEOUT = 60
MSG = 'O INA O BAPA LEMA LALO BAKATOAN, LAKO TODE LAMUNG BELANG PAMELI SEN SAGOBANG, JINA GENDRA TODE ANA KENANG KABAYA MIRA, TENDRI ATE KU PE INA PANYORONG BEDES KE DOMA, O INA O BAPA LEMA LALO BAKATOAN KU SATE MO PANGANTAN KE TODE LAMUNG BELANG LAMEN PAKO SIA TINGI MOLE ATE KU KABALI, URUNG MO KU BASAWAI JERA MATA TEN MUDI'
COR = '<b><font color="green">'
FTAG = '</font>'
